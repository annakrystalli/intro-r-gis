...
When a lat/lon CRS is flattened, the implicit flattening function used is the  Plate Carree Flattening Function, one of the simplest functions that simply turns the globe into a cylinder and then unwraps it, resulting in increasing distortion of features as one approaches the poles.
